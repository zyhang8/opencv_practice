...
#define WindowNameHoughSrc "hough_lena"	//定义窗口名字的宏
#define WindowNameHoughImg "hough_car"	//定义窗口名字的宏
...
int main()
{
	...
	*/
	...
	Canny(gaosi_src, canny_src, 102, 12, 3);
	Canny(gaosi_img, canny_img, 246, 0, 3);
