...
int main()
{
	...
	getContours(0, 0);
	createTrackbar("yuzhi", "dst", &threadhold_value, threadhold_max, getContours);
	//Canny(range, canny_out, threadhold_value, threadhold_value * 2);
