...
int main()
{
	...
	for (int i = 0; i < contours.size(); i++)
	{
		...
		cout << boundRect[i].y << endl;
		m_select = Rect(boundRect[0].x, boundRect[0].y, boundRect[2].width, boundRect[2].height);
		m_select = Rect(boundRect[1].x, boundRect[1].y, boundRect[2].width, boundRect[2].height);
		m_select = Rect(boundRect[2].x, boundRect[2].y, boundRect[2].width, boundRect[2].height);
		m_select = Rect(boundRect[3].x, boundRect[3].y, boundRect[2].width, boundRect[2].height);
		/*
		if (i == 2) {
